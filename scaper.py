    ...
    for i  in range(1,5):
         while True:
            ...
            if current_page_num<i :
                browser.find_element(By.XPATH, value = '//*[@id="mw-content-text"]/div[1]/table[8]/thead').click()
            elif current_page_num>i :
                browser.find_element(By.XPATH, value = '//*[@id="mw-content-text"]/div[1]/table[8]/tbody').click()
            else:
                break    
